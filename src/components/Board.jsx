...
import { PauseContext, TurnContext } from '../App'
        ...
        <div className="mx-auto w-[min(100%-40px,632px)] pt-12">
            ...
            <div className="flex justify-center gap-5 pt-12 font-bold">
                <div className="relative w-[42.388%] rounded-2xl border-4 border-black bg-white shadow-[0_10px_0_0_#000]">
                    <div className="flex flex-col items-center justify-center px-9 py-2 uppercase md:flex-row md:gap-5 md:py-4">
                        <div className="md:text-xl">Player 1</div>
                        <div className="text-3xl md:text-6xl">{scoreP1}</div>
                    </div>
                    <img src={Player1} alt="Player 1" className="absolute left-[-1.6875rem] top-[15%] h-[3.6875rem] w-[3.375rem]" />
                </div>
                <div className="relative w-[42.388%] rounded-2xl border-4 border-black bg-white shadow-[0_10px_0_0_#000]">
                    <div className="flex flex-col items-center justify-center px-9 py-2 uppercase md:flex-row-reverse md:gap-5 md:py-4">
                        <div className="md:text-xl">Player 2</div>
                        <div className="text-3xl md:text-6xl">{scoreP1}</div>
                    </div>
                    <img src={Player2} alt="Player 2" className="absolute right-[-1.6875rem] top-[15%] h-[3.6875rem] w-[3.375rem]" />
                </div>
            </div>

            <div className=" relative mx-auto mt-16 flex  aspect-[1.25219/1] w-full flex-wrap items-center justify-center gap-[3.797%] md:mt-20 md:gap-[24px]">
                <div className="absolute top-[-60px] z-50 hidden w-full justify-center gap-[3.797%] md:gap-[24px] lg:flex ">
                    {pings.map((e, indexPing) => (
                        <div className={`flex w-[10.1492%] justify-center ${e === 1 ? 'opacity-100' : 'opacity-0'}`} key={indexPing}>
